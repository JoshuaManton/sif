...
void references();
i32 main();
void vector_proc(struct Vector3 v);
i64 return_stuff();
struct Static_Array_8_bool ;
struct T;
struct Static_Array_8_i64 ;
struct B;
struct Static_Array_4_B_ ;
struct A;
struct Contains_Pointers1;
struct Self_Pointer;
void AAA();
struct Static_Array_4_Static_Array_8_i64 ;
struct Static_Array_4_ptr_i64 ;
struct Static_Array_8_ptr_ptr_i64 ;
struct Static_Array_4_Static_Array_8_ptr_ptr_i64 ;
struct Some_Struct;
void recursion();
void duo_recursion2();
void duo_recursion1();
void bar(i64 x);
struct Static_Array_149_bool ;
void foo2(i64 x);
void baz(i64 x);
struct Contains_Pointers2;
struct Static_Array_4_ptr_Static_Array_8_i64 ;
struct Static_Array_32_ptr_i64 ;
struct Static_Array_8_Static_Array_32_ptr_i64 ;
struct Static_Array_4_ptr_Static_Array_8_Static_Array_32_ptr_i64 ;
...
struct Vector3 __operator_overload_Vector3_TK_PLUS_Vector3(struct Vector3 a, struct Vector3 b) {
    struct Vector3 __generated_compound_literal_0 = {0};
...
void operator_overloading() {
    ...
    struct Vector3 v1 = __generated_compound_literal_5;
    ...
    struct Vector3 v2 = __generated_compound_literal_6;
...
struct Custom_Array_Type__polymorph_5 {
    struct Static_Array_16_i64 array;
};
...
void dynamic_arrays() {
    ...
    print_float((*__operator_overload_Dynamic_Array__polymorph_6_TK_LEFT_SQUARE_i64(&dyn, 1)).x);
    print_float((*__operator_overload_Dynamic_Array__polymorph_6_TK_LEFT_SQUARE_i64(&dyn, 1)).y);
    print_float((*__operator_overload_Dynamic_Array__polymorph_6_TK_LEFT_SQUARE_i64(&dyn, 1)).z);
...
struct A {
    struct Static_Array_4_B_ b;
};
struct Contains_Pointers1 {
    struct Contains_Pointers2 *a;
};
struct Self_Pointer {
    struct Self_Pointer *b;
};
void AAA() {
    struct A aa = {0};
    struct B b = aa.b.elements[2];
    struct Contains_Pointers1 *c = {0};
    struct Contains_Pointers2 *d = c->a;
    c->a = d;
    struct Self_Pointer e = {0};
}
i64 simple = {0};
i64 *pointer = {0};
struct Static_Array_4_i64 array = {0};
i64 **pointer_to_pointer = {0};
struct Static_Array_4_Static_Array_8_i64  {
    struct Static_Array_8_i64  elements[4];
};
struct Static_Array_4_Static_Array_8_i64 array_of_arrays = {0};
struct Static_Array_4_i64 *pointer_to_array = {0};
struct Static_Array_4_ptr_i64  {
    i64 * elements[4];
};
struct Static_Array_4_ptr_i64 array_of_pointers = {0};
struct Static_Array_4_Static_Array_8_i64 **wack = {0};
struct Static_Array_8_ptr_ptr_i64  {
    i64 ** elements[8];
};
struct Static_Array_4_Static_Array_8_ptr_ptr_i64  {
    struct Static_Array_8_ptr_ptr_i64  elements[4];
};
struct Static_Array_4_Static_Array_8_ptr_ptr_i64 more_wack = {0};
struct Static_Array_4_ptr_Static_Array_8_i64 *still_more_wack = {0};
struct Static_Array_4_ptr_Static_Array_8_Static_Array_32_ptr_i64 **complicated_garbage = {0};
struct Some_Struct {
    i64 x;
};
void recursion() {
...
void foo2(i64 x) {
    bar(1);
    struct Some_Struct b = {0};
    struct Static_Array_149_bool neato = {0};
    i64 z = {0};
    z = 321;
}
void baz(i64 x) {
...
struct Static_Array_8_Static_Array_32_ptr_i64  {
    struct Static_Array_32_ptr_i64  elements[8];
};
struct Static_Array_4_ptr_Static_Array_8_Static_Array_32_ptr_i64  {
    struct Static_Array_8_Static_Array_32_ptr_i64 * elements[4];
};
